...
export interface ApiGalleriaGalleria extends Struct.CollectionTypeSchema {
  collectionName: 'gallerias';
  info: {
    singularName: 'galleria';
    pluralName: 'gallerias';
...
export interface ApiHowOrderHowOrder extends Struct.CollectionTypeSchema {
  collectionName: 'how_orders';
  info: {
    singularName: 'how-order';
    pluralName: 'how-orders';
    displayName: 'How order';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    categorias: Schema.Attribute.Relation<'manyToMany', 'api::article.article'>;
    ...
    image: Schema.Attribute.Media<
      ...
      true
    >;
    itemQuantityType: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::galleria.galleria': ApiGalleriaGalleria;
      'api::global.global': ApiGlobalGlobal;
      'api::how-order.how-order': ApiHowOrderHowOrder;
